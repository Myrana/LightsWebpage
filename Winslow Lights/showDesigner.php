...
<?php
    ...
    {
        echo '<p><button onClick="saveShowSettings();" name="SavePlayList">Save PlayList</button><button type="submit" onClick="commitShowSettings();"  name="CommitPlayList" id="CommitPlayList">Commit PlayList</button></p>';
    }
    ?>
